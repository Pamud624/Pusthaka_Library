...
$sql="SELECT cc.cid, c.bid, c.access_no, b.title FROM (copy_check cc LEFT JOIN copy c ON cc.cid=c.cid) LEFT JOIN book b ON c.bid = b.bid WHERE cc.name='201801' AND (NOT c.access_no='') ORDER BY c.access_no+0";
