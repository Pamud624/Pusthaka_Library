...
&nbsp;(yyyy-mm-dd)&nbsp; </td>
                ...
                <tr>
                  ...
                  <select name="copy_status" id="copy_status">				  
                    ...
                    <option value="Damaged" <?php if($row2['copy_status']=='Damaged') echo 'selected'; ?>>D (Book is Damaged)</option>
                    <option value="L" <?php if($row2['copy_status']=='L') echo 'selected'; ?>>L (Lost)</option>                    
			...
			<option value="RO" <?php if($row2['copy_status']=='RO') echo 'selected'; ?>>RO (Right Off)</option>
				...
				<tr>
					...
					<td> <input name="currancy" type="text" id="currancy" value="<?php echo $row2['currancy'] ?>" size="15" style="width:60px">	</td>
					
					<td> Price  <input name="price" type="number" id="price2" value="<?php echo $row2['price'] ?>" size="15">	</td>
