<?php
	...
	if(!is_null($bookCopy)){
		...
		$sql3 = "SELECT * FROM copy_check WHERE name='201801' AND cid=" . $bookCopy['cid'];
		...
		if($rowcount3>0){ // already checked-in
			...
			$sql4 = sprintf("INSERT into copy_check (name, datetime, cid, checked, mid, comments) VALUES ('201801','%s',%d,1,%d,'')",
