 ...
 <div class="span5">
  <div class="well">
   <div>
     ...
     <label><input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $result[8]['Tables_in_pusthaka']; ?>" /> Lending  </label>
     <label><input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $result[2]['Tables_in_pusthaka']; ?>" /> Config  </label>
     <label><input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $result[0]['Tables_in_pusthaka']; ?>" /> Book  </label>
