...
///***********************************************************************************************************************//////////////////////////
     ...
     $query="SELECT copy.cid,copy.bid ,copy.access_no,book.title, book.authors,book.isbn FROM  copy LEFT JOIN book ON copy.bid=book.bid WHERE  copy.copy_status='OK' AND cid  NOT IN  (SELECT cid FROM  copy_check  WHERE name= $year ) AND cid  NOT IN  (SELECT copy FROM  loan  WHERE returned=0 )" ; 
