  ...
  if(isset($_REQUEST['BtnUpdate1'])){
    ...
    if(isset($_REQUEST['allowed']) && $_REQUEST['allowed']== 1){
      ...
      $sql = sprintf("update lending_settings set allowed=%d, num_allowed=%d," .
        "days_allowed=%d , privile='%s' WHERE id=22",$allowed, $num_allowed, $days_allowed, $abc);
      ...
      $sql = sprintf("update lending_settings set allowed=%d, num_allowed=%d," .
        "days_allowed=%d, privile='%s' WHERE id=22",$allowed, 0, 0,$cdf);
      $a = executeSqlNonQuery($sql);
      ...
      exit();
       ...
       $sql = sprintf("update lending_settings set allowed=%d, num_allowed=%d," .
        "days_allowed=%d  WHERE id=22",$allowed, $num_allowed, $days_allowed);
      $a = executeSqlNonQuery($sql);
...
<div class="row" align="center">
  ...
  <div class="span11">
    <form form action="config7.php" method="post" name="my_info"  id="my_info">
<div class="well" align="center">

  <div>
     <p class="h3" align="center"><b>Research Student(L) Settings</b></p>     
   </div>
   <div class="well">
   <div class="row">
